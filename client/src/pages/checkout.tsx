              ...
              <Card>
                ...
                <CardContent>
                    ...
                    {cartItems.map((item: any) => (
                      <div key={item.id} className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-semibold text-minas-green">
                  ...
                  <div className="border-t pt-4 mt-4">
                    ...
                    <div className="flex justify-between items-center mb-2">
                      <span>Frete:</span>
                      <span className="text-minas-green">
                        {total >= 150 ? "Grátis" : "R$ 15,00"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center text-xl font-bold text-traditional-blue">
                      <span>Total:</span>
                      <span>R$ {(total + (total >= 150 ? 0 : 15)).toFixed(2)}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
